...
internal class BiFailureMaybeMatchersTest : FreeSpec() {
    ...
    private companion object {
        private const val EXPECTED_ERROR_TYPE = "Maybe.Some<Fail.Error<Errors>>"
        private const val EXPECTED_EXCEPTION_TYPE = "Maybe.Some<Fail.Exception<Exceptions>>"

        private val expectedErrorValue = Maybe.Some(Fail.Error(Errors))
        private val expectedExceptionValue = Maybe.Some(Fail.Exception(Exceptions))
    }
